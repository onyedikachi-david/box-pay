...
const Code = () => {
  ...
  const [mumbaiRedeemablePayments, setMumbaiRedeemablePayments] =
    React.useState([]);
  const [goerliRedeemablePayments, setGoerliRedeemablePayments] =
    React.useState([]);
  ...
  return (
    ...
    <DLayout>
      <div
        className={` h-full min-h-screen w-full grid grid-cols-[repeat(7,1fr)] grid-rows-[100px,25px,auto,100px] bg-[ghostwhite] dark:bg-[#bcbcd6]`}
      >
        <Head>
          <title>Paylock</title>
            ...
            <React.Fragment>
              {isConnected ? (
                <>
                  ...
                  {mumbaiRedeemablePayments.length == 0 &&
                    goerliRedeemablePayments.length == 0 && (
                      <span
                        className={`
                                        col-start-1 col-end-8 row-start-2 row-end-3
                                       bg-[aliceblue] dark:bg-[#1e1d45]
